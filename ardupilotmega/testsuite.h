...
static void mavlink_test_custom_payload_control(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CUSTOM_PAYLOAD_CONTROL >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_custom_payload_control_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CUSTOM_PAYLOAD_CONTROL_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CUSTOM_PAYLOAD_CONTROL_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_custom_payload_control_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_custom_payload_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_custom_payload_control_pack(system_id, component_id, &msg , packet1.command_target , packet1.command_value );
    mavlink_msg_custom_payload_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_custom_payload_control_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.command_target , packet1.command_value );
    mavlink_msg_custom_payload_control_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_custom_payload_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_custom_payload_control_send(MAVLINK_COMM_1 , packet1.command_target , packet1.command_value );
    mavlink_msg_custom_payload_control_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("CUSTOM_PAYLOAD_CONTROL") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_CUSTOM_PAYLOAD_CONTROL) != NULL);
#endif
}

static void mavlink_test_connected_payload(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CONNECTED_PAYLOAD >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_connected_payload_t packet_in = {
        17235,"CDEFGHIJKLMNOPQRSTUVWXYZABCDEFG","IJKLMNOPQRSTUVWXYZABCDEFGHIJKLM"
    };
    mavlink_connected_payload_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.payload_id = packet_in.payload_id;
        
        mav_array_memcpy(packet1.payload_name, packet_in.payload_name, sizeof(char)*32);
        mav_array_memcpy(packet1.payload_state, packet_in.payload_state, sizeof(char)*32);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CONNECTED_PAYLOAD_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CONNECTED_PAYLOAD_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_connected_payload_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_connected_payload_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_connected_payload_pack(system_id, component_id, &msg , packet1.payload_id , packet1.payload_name , packet1.payload_state );
    mavlink_msg_connected_payload_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_connected_payload_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.payload_id , packet1.payload_name , packet1.payload_state );
    mavlink_msg_connected_payload_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_connected_payload_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_connected_payload_send(MAVLINK_COMM_1 , packet1.payload_id , packet1.payload_name , packet1.payload_state );
    mavlink_msg_connected_payload_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("CONNECTED_PAYLOAD") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_CONNECTED_PAYLOAD) != NULL);
#endif
}

static void mavlink_test_connected_payload_ack(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CONNECTED_PAYLOAD_ACK >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_connected_payload_ack_t packet_in = {
        17235,"CDEFGHIJKLMNOPQRSTUVWXYZABCDEFG","IJKLMNOPQRSTUVWXYZABCDEFGHIJKLM",75
    };
    mavlink_connected_payload_ack_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.payload_id = packet_in.payload_id;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CONNECTED_PAYLOAD_ACK_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CONNECTED_PAYLOAD_ACK_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_connected_payload_ack_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_connected_payload_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_connected_payload_ack_pack(system_id, component_id, &msg , packet1.payload_id , packet1.payload_name , packet1.payload_state , packet1.result );
    mavlink_msg_connected_payload_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_connected_payload_ack_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.payload_id , packet1.payload_name , packet1.payload_state , packet1.result );
    mavlink_msg_connected_payload_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_connected_payload_ack_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_connected_payload_ack_send(MAVLINK_COMM_1 , packet1.payload_id , packet1.payload_name , packet1.payload_state , packet1.result );
    mavlink_msg_connected_payload_ack_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("CONNECTED_PAYLOAD_ACK") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_CONNECTED_PAYLOAD_ACK) != NULL);
#endif
}
...
static void mavlink_test_ardupilotmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_custom_payload_control(system_id, component_id, last_msg);
    mavlink_test_connected_payload(system_id, component_id, last_msg);
    mavlink_test_connected_payload_ack(system_id, component_id, last_msg);
